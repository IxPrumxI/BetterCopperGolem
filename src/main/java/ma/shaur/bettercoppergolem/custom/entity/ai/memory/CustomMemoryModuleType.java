...
public class CustomMemoryModuleType<U> extends MemoryModuleType<U> {
    ...
    public static CustomMemoryModuleType<PositionTracker> TRANSPORT_LAST_EMPTY_CHEST_POS;
    ...
    public static void init() {
        ...
        TRANSPORT_LAST_EMPTY_CHEST_POS = register("transport_last_empty_chest_pos");
